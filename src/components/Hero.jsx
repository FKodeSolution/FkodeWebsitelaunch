...
const FKodeCountdown = () => {
  // STRICT TARGET: 13 June 2026 at 11:00 AM IST
  const calculateTimeLeft = () => {
    const difference = +new Date("2026-06-13T11:00:00") - +new Date();
  ...
  return (
    // h-screen & overflow-hidden ensures a true single-page layout with zero scrollbars
    <section className="relative h-screen w-screen bg-[#000000] text-white flex flex-col items-center justify-between py-6 px-4 overflow-hidden font-sans select-none">
      ...
      {/* PURE BLACK & GOLD AMBIENT BACKGROUND CORE */}
      ...
      {/* Massive Center Gold Lighting to Kill Empty Space */}
      ...
      {/* Elegant Golden Particle Dust Overlay */}
      ...
      <div className="w-full max-w-7xl mx-auto flex justify-between items-center z-10 border-b border-amber-500/[0.05] pb-3 shrink-0">
        <div className="flex items-center gap-2">
          ...
          <span className="font-mono text-[9px] sm:text-[10px] font-black tracking-[0.25em] uppercase bg-amber-500/[0.02] border border-amber-500/20 px-3 py-1 rounded text-amber-400/90 backdrop-blur-md">
           VERSION 3
          </span>
        </div>
        <span className="font-mono text-[9px] tracking-[0.2em] text-neutral-500 uppercase font-black hidden sm:block">
          FY-2026 // GRAND_LAUNCH
        </span>
      </div>

      {/* CENTER COMPONENT CORE: COMPACT SPACING FOR TRUE SINGLE PAGE FIT */}
      <div className="flex flex-col items-center text-center max-w-5xl mx-auto z-10 justify-center gap-6 sm:gap-10 my-auto w-full py-2 flex-1">
        ...
        <div className="flex flex-col items-center space-y-3 group shrink-0">
          <div className="relative w-28 h-28 sm:w-40 sm:h-40 md:w-44 md:h-44 flex items-center justify-center bg-gradient-to-b from-neutral-900 to-black border-2 border-amber-500/30 rounded-3xl shadow-[0_25px_60px_rgba(0,0,0,0.9)] transition-all duration-700 p-5 sm:p-6">
            ...
            {/* Native High-Fidelity Backup Character Vector */}
        ...
        {/* COMPREHENSIVE GOLD SEPARATOR LINE */}
        ...
        {/* HIGH-FIDELITY GLASSMORPHISM COUNTDOWN TILES */}
        <div className="grid grid-cols-4 gap-2 sm:gap-4 md:gap-6 w-full max-w-4xl px-2 sm:px-4">
          {[
            ...
            >
              {/* Internal Premium Highlight Border Rim */}
      ...
      {/* FOOTER LAYER: ATMOSPHERIC HORIZON ARC & DATA */}
      <div className="w-full flex flex-col items-center relative shrink-0 pt-2">
        
        {/* DENSE GOLDEN HORIZON LINE LAYER */}
